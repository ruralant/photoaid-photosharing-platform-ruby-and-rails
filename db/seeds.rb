...
campaign1.campaign_logo = Rails.root.join("./public/img/amnesty_logo.jpg").open
campaign1.save!
...
campaign2.campaign_logo = Rails.root.join("./public/img/amnesty_logo.jpg").open
campaign2.save!
...
campaign3.campaign_logo = Rails.root.join("./public/img/amnesty_logo.jpg").open
campaign3.save!
...
campaign4.campaign_logo = Rails.root.join("./public/img/amnesty_logo.jpg").open
campaign4.save!
...
campaign5.campaign_logo = Rails.root.join("./public/img/amnesty_logo.jpg").open
campaign5.save!
...
campaign6.campaign_logo = Rails.root.join("./public/img/amnesty_logo.jpg").open
campaign6.save!
...
campaign7.campaign_logo = Rails.root.join("./public/img/amnesty_logo.jpg").open
campaign7.save!
...
campaign8.campaign_logo = Rails.root.join("./public/img/amnesty_logo.jpg").open
campaign8.save!
...
campaign9.campaign_logo = Rails.root.join("./public/img/amnesty_logo.jpg").open
campaign9.save!
...
campaign10.campaign_logo = Rails.root.join("./public/img/amnesty_logo.jpg").open
campaign10.save!
...
photo1.campaign_pic = Rails.root.join("./public/img/amnesty_logo.jpg", user_id: user1, campaign_id: campaign1).open
photo1.save!
