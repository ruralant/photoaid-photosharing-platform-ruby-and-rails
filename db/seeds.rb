...
photo1 = Photo.create(title:"Still Hope", location:"Kuala Lumpur", description:"A young boy born in the outskirt of a capital in a developing country", user_id: user1, campaign_id: campaign1, campaign_pic: open("./public/img/photo1.jpg"))

photo2 = Photo.create(title:"American Dream", location:"USA", description:"Black and white street photo in Columbia, USA", user_id: user1, campaign_id: campaign2, campaign_pic: open("./public/img/photo2.jpg"))

photo3 = Photo.create(title:"Life in the countryside", location:"Spain", description:"A little girl was her hands after a day in the field", user_id: user1, campaign_id: campaign3, campaign_pic: open("./public/img/photo3.jpg"))

photo4 = Photo.create(title:"Eyes", location:"Uganda", description:"They still have hope in their eyes", user_id: user1, campaign_id: campaign1, campaign_pic: open("./public/img/photo4.jpg"))

photo5 = Photo.create(title:"Glacier under attack", location:"Antartica", description:"Artic penguins on a piece of iceberg grabbed by the currents.", user_id: user2, campaign_id: campaign4, campaign_pic: open("./public/img/photo5.jpg"))

photo6 = Photo.create(title:"Deforestation", location:"Canada", description:"A man is standing on a devatated land.", user_id: user2, campaign_id: campaign4, campaign_pic: open("./public/img/photo6.jpg"))

photo7 = Photo.create(title:"Poisoned Ocean", location:"Thailand", description:"A young girt is walkign near a beach completely covered by rubbish.", user_id: user2, campaign_id: campaign5, campaign_pic: open("./public/img/photo7.jpg"))

photo8 = Photo.create(title:"Stop Global Working", location:"Brazil", description:"Activists in sounth america against the golobal worming", user_id: user2, campaign_id: campaign5, campaign_pic: open("./public/img/photo8.jpg"))

photo9 = Photo.create(title:"", location:"", description:"", user_id: user3, campaign_id: campaign6, campaign_pic: open("./public/img/photo1.jpg"))

photo10 = Photo.create(title:"", location:"", description:"", user_id: user3, campaign_id: campaign6, campaign_pic: open("./public/img/photo1.jpg"))

photo11 = Photo.create(title:"", location:"", description:"", user_id: user3, campaign_id: campaign6, campaign_pic: open("./public/img/photo1.jpg"))

photo12 = Photo.create(title:"", location:"", description:"", user_id: user3, campaign_id: campaign6, campaign_pic: open("./public/img/photo1.jpg"))

photo13 = Photo.create(title:"", location:"", description:"", user_id: user4, campaign_id: campaign7, campaign_pic: open("./public/img/photo1.jpg"))

photo14 = Photo.create(title:"", location:"", description:"", user_id: user4, campaign_id: campaign7, campaign_pic: open("./public/img/photo1.jpg"))

photo15 = Photo.create(title:"", location:"", description:"", user_id: user4, campaign_id: campaign8, campaign_pic: open("./public/img/photo1.jpg"))

photo16 = Photo.create(title:"", location:"", description:"", user_id: user4, campaign_id: campaign8, campaign_pic: open("./public/img/photo1.jpg"))

photo17 = Photo.create(title:"", location:"", description:"", user_id: user5, campaign_id: campaign9, campaign_pic: open("./public/img/photo1.jpg"))

photo18 = Photo.create(title:"", location:"", description:"", user_id: user5, campaign_id: campaign9, campaign_pic: open("./public/img/photo1.jpg"))

photo19 = Photo.create(title:"", location:"", description:"", user_id: user5, campaign_id: campaign10, campaign_pic: open("./public/img/photo1.jpg"))

photo20 = Photo.create(title:"", location:"", description:"", user_id: user5, campaign_id: campaign10, campaign_pic: open("./public/img/photo1.jpg"))

photo21 = Photo.create(title:"", location:"", description:"", user_id: user6, campaign_id:, campaign_pic: open("./public/img/photo1.jpg"))

photo22 = Photo.create(title:"", location:"", description:"", user_id: user6, campaign_id:, campaign_pic: open("./public/img/photo1.jpg"))

photo23 = Photo.create(title:"", location:"", description:"", user_id: user6, campaign_id:, campaign_pic: open("./public/img/photo1.jpg"))

photo24 = Photo.create(title:"", location:"", description:"", user_id: user6, campaign_id:, campaign_pic: open("./public/img/photo1.jpg"))

photo25 = Photo.create(title:"", location:"", description:"", user_id: user7, campaign_id:, campaign_pic: open("./public/img/photo1.jpg"))

photo26 = Photo.create(title:"", location:"", description:"", user_id: user7, campaign_id:, campaign_pic: open("./public/img/photo1.jpg"))

photo27 = Photo.create(title:"", location:"", description:"", user_id: user7, campaign_id:, campaign_pic: open("./public/img/photo1.jpg"))

photo28 = Photo.create(title:"", location:"", description:"", user_id: user7, campaign_id:, campaign_pic: open("./public/img/photo1.jpg"))

photo29 = Photo.create(title:"", location:"", description:"", user_id: user8, campaign_id:, campaign_pic: open("./public/img/photo1.jpg"))

photo30 = Photo.create(title:"", location:"", description:"", user_id: user8, campaign_id:, campaign_pic: open("./public/img/photo1.jpg"))

photo31 = Photo.create(title:"", location:"", description:"", user_id: user8, campaign_id: campaign, campaing_pic: open("./public/img/photo1.jpg"))

photo32 = Photo.create(title:"", location:"", description:"", user_id: user8, campaign_id: campaign, campaing_pic: open("./public/img/photo1.jpg"))

photo33 = Photo.create(title:"", location:"", description:"", user_id: user9, campaign_id: campaign, campaing_pic: open("./public/img/photo1.jpg"))

photo34 = Photo.create(title:"", location:"", description:"", user_id: user9, campaign_id: campaign, campaing_pic: open("./public/img/photo1.jpg"))

photo35 = Photo.create(title:"", location:"", description:"", user_id: user9, campaign_id: campaign, campaing_pic: open("./public/img/photo1.jpg"))

photo36 = Photo.create(title:"", location:"", description:"", user_id: user9, campaign_id: campaign, campaing_pic: open("./public/img/photo1.jpg"))

photo37 = Photo.create(title:"", location:"", description:"", user_id: user10, campaign_id: campaign, campaing_pic: open("./public/img/photo1.jpg"))

photo38 = Photo.create(title:"", location:"", description:"", user_id: user10, campaign_id: campaign, campaing_pic: open("./public/img/photo1.jpg"))

photo39 = Photo.create(title:"", location:"", description:"", user_id: user10, campaign_id: campaign, campaing_pic: open("./public/img/photo1.jpg"))

photo40 = Photo.create(title:"", location:"", description:"", user_id: user10, campaign_id: campaign, campaing_pic: open("./public/img/photo1.jpg"))