...
campaign1 = Campaign.create(title:"a", description:"l", campaign_logo:"")
campaign2 = Campaign.create(title:"b", description:"i", campaign_logo:"")
campaign3 = Campaign.create(title:"c", description:"h", campaign_logo:"")
campaign4 = Campaign.create(title:"d", description:"g", campaign_logo:"")
campaign5 = Campaign.create(title:"e", description:"f", campaign_logo:"")
