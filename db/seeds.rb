...
user1 = User.create(name: "Oxfam", location:"London", description:"We are Oxfam", website:"www.oxfam.co.uk", facebook_profile:"Oxfam", twitter_profile:"oxfam", role: "charity", email: "oxfam@oxfam.co.uk", password: "password", password_confirmation: "password", profile_picture: "../public/img/oxfam_logo.png")
