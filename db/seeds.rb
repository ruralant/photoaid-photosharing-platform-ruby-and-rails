...
user1 = User.create(name: "Oxfam", location:"London", description:"We are Oxfam", website:"www.oxfam.co.uk", facebook_profile:"Oxfam", twitter_profile:"oxfam", role: "charity", email: "oxfam@oxfam.co.uk", password: "password", password_confirmation: "password")
  user1.profile_picture = Rails.root.join("./public/img/oxfam_logo.jpg").open
  user1.save!
...
user2.profile_picture = Rails.root.join("./public/img/bhf_logo.jpg").open
user2.save!
...
user3.profile_picture = Rails.root.join("./public/img/msf_logo.jpg").open
user3.save!
...
user5.profile_picture = Rails.root.join("./public/img/amnesty_logo.jpg").open
user5.save!
...
user6.profile_picture = Rails.root.join("./public/img/amnesty_logo.jpg").open
user6.save!
...
user7.profile_picture = Rails.root.join("./public/img/amnesty_logo.jpg").open
user7.save!
...
user8.profile_picture = Rails.root.join("./public/img/amnesty_logo.jpg").open
user8.save!
...
user9.profile_picture = Rails.root.join("./public/img/amnesty_logo.jpg").open
user9.save!
...
user10.profile_picture = Rails.root.join("./public/img/amnesty_logo.jpg").open
user10.save!
...
# campaign3 = Campaign.create(title:"Safety and dignity", description:"When the world's poorest and most vulnerable people are hit by disasters, we help make their voices heard.", campaign_logo:"", user_id: user1)
...
# campaign6 = Campaign.create(title:"Search and rescue in the Mediterranean Sea", description:"In 2015, we carried out search and rescue operations in the Mediterranean, providing lifesaving support to people in distress.", campaign_logo:"")
# campaign7 = Campaign.create(title:"Rescing Migrants in the Mediterranean Sea", description:"In front of me, in the middle of the sea between Italy and Libya, were hundreds of youngsters. We rescued them one by one.", campaign_logo:"")
# campaign8 = Campaign.create(title:"Ebola Response", description:"The first cases were in Guinea, then Liberia, and the Ebola outbreak finally hit Sierra Leone in May 2014. To respond to this new crisis, EMERGENCY already had its Surgical and Paediatric Centre in Goderich – the traumatology centre of reference for West Africa for many years – reorganised and ready by more or less the beginning of the year.", campaign_logo:"")
# campaign9 = Campaign.create(title:"Human Right Act", description:"The Human Rights Act is a powerful tool. It brings home fundamental, universal rights we all have as human beings, and allows us to challenge authorities if they violate them. Attacked by some, misreported by others and misunderstood by many – it’s time to spread the message that human rights matter.", campaign_logo:"")
# campaign10 = Campaign.create(title:"Free Speech", description:"Free speech is the right to say whatever you like about whatever you like, whenever you like, right? Wrong. Free speech is one of our most important rights and one of the most misunderstood. Use your free speech to speak out for those that are denied theirs. But use it responsibly, it is a powerful thing.", campaign_logo:"")
...
# photo2 = Photo.create(title:"American Dream", location:"USA", description:"Black and white street photo in Columbia, USA")
# photo3 = Photo.create(title:"Life in the countryside", location:"Spain", description:"A little girl was her hands after a day in the field")
# photo4 = Photo.create(title:"Eyes", location:"Uganda", description:"They still have hope in their eyes")
# photo5 = Photo.create(title:"Glacier under attack", location:"Antartica", description:"Artic penguins on a piece of iceberg grabbed by the currents.")
# photo6 = Photo.create(title:"Deforestation", location:"Canada", description:"A man is standing on a devatated land.")
# photo7 = Photo.create(title:"Poisoned Ocean", location:"Thailand", description:"A young girt is walkign near a beach completely covered by rubbish.")
# photo8 = Photo.create(title:"Stop Global Working", location:"Brazil", description:"Activists in sounth america against the golobal worming")
