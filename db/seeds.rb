...
photo1 = Photo.create(title:"Still Hope", location:"Kuala Lumpur", description:"A young boy born in the outskirt of a capital in a developing country", user_id: user1.id, campaign_id: campaign1.id, campaign_pic: open("./public/img/photo1.jpg"))

photo2 = Photo.create(title:"American Dream", location:"USA", description:"Black and white street photo in Columbia, USA", user_id: user1.id, campaign_id: campaign2.id, campaign_pic: open("./public/img/photo2.jpg"))

photo3 = Photo.create(title:"Life in the countryside", location:"Spain", description:"A little girl was her hands after a day in the field", user_id: user1.id, campaign_id: campaign3.id, campaign_pic: open("./public/img/photo3.jpg"))

photo4 = Photo.create(title:"Eyes", location:"Uganda", description:"They still have hope in their eyes", user_id: user1.id, campaign_id: campaign1.id, campaign_pic: open("./public/img/photo4.jpg"))

photo5 = Photo.create(title:"Glacier under attack", location:"Antartica", description:"Artic penguins on a piece of iceberg grabbed by the currents.", user_id: user2.id, campaign_id: campaign4.id, campaign_pic: open("./public/img/photo5.jpg"))

photo6 = Photo.create(title:"Deforestation", location:"Canada", description:"A man is standing on a devatated land.", user_id: user2.id, campaign_id: campaign4.id, campaign_pic: open("./public/img/photo6.jpg"))

photo7 = Photo.create(title:"Poisoned Ocean", location:"Thailand", description:"A young girt is walkign near a beach completely covered by rubbish.", user_id: user2.id, campaign_id: campaign5.id, campaign_pic: open("./public/img/photo7.jpg"))
...
.id
photo38 = Photo.create(title:"Freendom of Speeh", location:"", description:"", user_id: user10.id, campaign_id: campaign10.id, campaign_pic: open("./public/img/photo38.jpg"))

photo39 = Photo.create(title:"Freendom of Speeh", location:"", description:"", user_id: user10.id, campaign_id: campaign10.id, campaign_pic: open("./public/img/photo39.jpg"))

photo40 = Photo.create(title:"Freendom of Speeh", location:"", description:"", user_id: user10.id, campaign_id: campaign10.id, campaign_pic: open("./public/img/photo40.jpg"))